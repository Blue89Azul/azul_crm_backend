...
- **Frontend:** Flutter [GitHub Repository](https://github.com/Blue89Azul/azul-crm)
- **Backend:** Laravel 12 [GitHub Repository](https://github.com/Blue89Azul/azul_crm_backend)
- **Database:** MySQL
